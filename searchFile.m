function [feature]=searchFile(filename,lbpPatches,colorPatches,colorlashTable,lbplashTable,testFileName)
    ...
    [lbp_nnlsh,~]=lshlookup(lbp1,lbpPatches,lbplashTable,'k',100,'distfun','lpnorm','distargs',{2});
    [color_nnlsh,~]=lshlookup(color1,colorPatches,colorlashTable,'k',100,'distfun','lpnorm','distargs',{2});
